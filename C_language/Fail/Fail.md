设有宏定义命令：#define RES 30-5 则表达式 RES\*5+30 的值为\_\_\_\_.
...
若有宏定义：#define Test(y)y\*y，则表达式 Test(4-2)的值为\_\_\_\_.
...
字符串”boy\0s”在内存中占用的字节数是\_\_\_\_.
...
设 a，b，c 均为 int 型变量，则执行语句 a=b=3;c=++a||++b;后，b 的值为\_\_\_\_\_\_\_.
...
设 x，y，z，t 均为 int 型变量，则执行以下语句 x=y=z=1;t=++x||++y&&++z; 后，t 的值为\_\_\_\_\_\_\_\_.
...
printf("s=%-5.3s","student");的输出结果是\_\_\_\_.
...
1. 输出用 1 元人民币换成 1 分、2 分、5 分的所有兑换方案。（填写循环与条件）
...
已知 int a=5,b=2; 表达式 a%b 的值是\_\_\_\_。

答案：1

已知 int a\[10]={1,2,3,4,5,6,7,0,9,6}; 最小的元素的下标值是\_\_\_\_。

答案：7

使用 TURBO C 系统编译 C 语言源程序后生成的文件名后缀是（\_\_\_\_\_）。

答案：.obj

若有以下宏定义： #define M(a,b) -a/b ，则执行语句 printf("%d", M(4+3, 2+1)); 后输出结果为（\_\_\_\_\_）。
